...
export default function Home() {
  return (
    <main className="w-screen h-screen relative">
      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[310px] md:max-w-[750px]">
          <h1 className="text-[20px] md:text-[50px] text-white font-semibold">
          ...
          <div className="flex-col md:flex-row hidden md:flex gap-5">
            <Link
              href="/my-skills"
              className="rounded-[20px] group relative bg-blue-500 hover:bg-blue-400 px-5 py-3 text-lg text-white max-w-[150px] md:max-w-[200px]"
            >
              Learn more
            </Link>
            <Link
